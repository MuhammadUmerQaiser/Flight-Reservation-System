            ...
            <div class="col-xl-12 col-lg-5 col-md-7 d-flex flex-column ms-auto me-auto ms-lg-auto me-lg-5">
              <div class="card card-plain">
                <div class="card-header">
                  <h4 class="font-weight-bolder">Add Flights</h4>
                </div>
                <div class="card-body">
                  <form role="form" action="add.php" method="post">
                    <div class="input-group input-group-outline mb-3">
                        <label class="form-label">Flight Number</label>
                        <input type="number" class="form-control" name="flight_no" required>
                    </div>
                    <div class="input-group input-group-outline mb-3">
                    ...
                    <div class="text-center">
                        <input type="submit" value="Add" class="btn btn-lg bg-gradient-primary btn-lg w-100 mt-4 mb-0" name="add">
                    </div>
                  </form>
                </div>
              </div>
